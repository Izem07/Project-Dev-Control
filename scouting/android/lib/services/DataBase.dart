...
class EndPoints {
  ...
  String toCsv() {
    final escapedComments = Comments.replaceAll('"',
            '""') // escape quotes inside comments (otherwise csv thinks comment is over)
        .replaceAll('\r',
            '') // strip carriage returns (otherwise csv thinks it's a new row)
        .replaceAll(
